...
public class PlayerController1 : MonoBehaviour
{
    ...
    {
        move = controls.Player2.ControllerMovement.ReadValue<Vector2>();
    ...
    public void Jump()
    {
        if (controls.Player2.Jump.triggered && isGrounded)
        {
    ...
    public void Interactions()
    {
        ...
        if (controls.Player2.Interactions.triggered)
        {
    ...
    public void Pickup()
    {
        ...
        if (controls.Player2.Pickup2.triggered && !holdGun && target)
        {
            holdGun = true;
            Shoot();
        }
        else if (controls.Player2.Pickup2.triggered && holdGun && target)
        {
            holdGun = false;
            UnequipObject();
        }
